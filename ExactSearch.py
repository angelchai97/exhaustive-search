...
numberofProblem = 50      
for x in range (1,numberofProblem + 1):
    if __name__ == '__main__':
        ...
        print()'''
        print("\n\n",x)
        print("Problem Generation: " + a.ProblemGenerator(60) + "\n")
        ...
        while a.x != ("1"*_input):     
            ...
            c = a.CheckProblem(b)
            if c == 1:
                print("Solution existed for this 3-SAT problem.")
                '''print(a.literalsValue)
                print(a.literalsValueComplement)
                print(b)
                print(c)'''
            ...
            if a.x == ("1"*_input) and c == 0:
                print("No solution existed for this 3-SAT problem.")

        end = time.time()
        total_computing_time = end-start
        print("\nTotal Computing time: ",str(round(total_computing_time, 3)),"s")
